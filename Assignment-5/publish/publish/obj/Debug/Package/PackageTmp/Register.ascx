<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Register.ascx.cs" Inherits="publish.Register" %>
...
<table id="registerTable" runat="server" style="margin: auto; margin-top: 80px; border: 1px black solid; background: #A9BCF5;" cellspacing="40">
    ...
    <tr>
        <td>
            <label id="Label5" runat="server" width="100px" style="font-family: Cambria;">Captcha</label>
        </td>
        <td>
